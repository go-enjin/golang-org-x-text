...
package utf32 // import "github.com/go-enjin/golang-org-x-text/encoding/unicode/utf32"
...
const (
	...
	// Consistent with BOMPolicy definition in github.com/go-enjin/golang-org-x-text/encoding/unicode
)
