...
package display // import "github.com/go-enjin/golang-org-x-text/language/display"
...
// Format implements "github.com/go-enjin/golang-org-x-text/internal/format".Formatter.
