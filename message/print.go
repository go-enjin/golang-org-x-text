...
// It implements "github.com/go-enjin/golang-org-x-text/internal/format".State.
type printer struct {
	Printer
...
// Language implements "github.com/go-enjin/golang-org-x-text/internal/format".State.
