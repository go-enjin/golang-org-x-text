...
package width // import "github.com/go-enjin/golang-org-x-text/width"
...
var (
	...
	//
	// Note that the NFKC and NFKD transforms in github.com/go-enjin/golang-org-x-text/unicode/norm
